...
`;function Hn({url:e,onDelete:t}){let{attributes:n,listeners:r,setNodeRef:i,transform:a,transition:o,isDragging:s}=An({id:e});return(0,$.jsxs)(`div`,{ref:i,className:`hp-edit-photo`,style:{transform:R.Transform.toString(a),transition:o,opacity:s?.5:1,cursor:s?`grabbing`:`grab`},...n,...r,children:[(0,$.jsx)(`img`,{src:e,alt:``,loading:`lazy`,decoding:`async`}),(0,$.jsx)(`button`,{className:`hp-delete-badge`,onPointerDown:e=>e.stopPropagation(),onClick:e=>{e.stopPropagation(),t()},children:`×`}),(0,$.jsx)(`span`,{className:`hp-drag-hint`,children:`⠿`})]})}function Un({title:e,urls:t,gallery:n,isAdmin:r,onOpen:i}){let[a,o]=(0,v.useState)(!1),[s,c]=(0,v.useState)([]),[l,u]=(0,v.useState)(!1),d=(0,v.useRef)(null),f=me(pe(st),pe(ft,{activationConstraint:{delay:200,tolerance:5}})),h=()=>{c([...t]),o(!0)},_=async()=>{o(!1),await p(n,s)},y=e=>{let{active:t,over:n}=e;n&&t.id!==n.id&&c(e=>mn(e,e.indexOf(t.id),e.indexOf(n.id)))},b=e=>{confirm(`この写真を削除しますか？`)&&c(t=>t.filter(t=>t!==e))},x=async e=>{u(!0);let t=[];for(let r of Array.from(e)){let e=await m(r,`galleries`,n);t.push(e),c(t=>[...t,e])}await g(n,t),u(!1)};(0,v.useEffect)(()=>{a||c([...t])},[t,a]);let S=a?s:t;return(0,$.jsx)(`div`,{className:`hp-gallery-block`,children:(0,$.jsxs)(`div`,{className:`hp-gallery-frame`,children:[(0,$.jsxs)(`div`,{className:`hp-gallery-header`,children:[(0,$.jsx)(`p`,{className:`hp-gallery-name`,children:e}),r&&(0,$.jsx)(`div`,{className:`hp-gallery-actions`,children:a?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`input`,{ref:d,type:`file`,accept:`image/*`,multiple:!0,style:{display:`none`},onChange:e=>e.target.files&&x(e.target.files)}),(0,$.jsx)(`button`,{className:`hp-gallery-action-btn`,onClick:()=>d.current?.click(),children:l?`追加中…`:`+ 追加`}),(0,$.jsx)(`button`,{className:`hp-gallery-action-btn done`,onClick:_,children:`完了`})]}):(0,$.jsx)(`button`,{className:`hp-gallery-action-btn`,onClick:h,children:`編集`})})]}),S.length===0?(0,$.jsx)(`p`,{className:`hp-gallery-empty`,children:`写真がまだありません`}):a?(0,$.jsx)(an,{sensors:f,collisionDetection:ye,onDragEnd:y,children:(0,$.jsx)(Sn,{items:s,strategy:yn,children:(0,$.jsx)(`div`,{className:`hp-edit-grid`,children:s.map(e=>(0,$.jsx)(Hn,{url:e,onDelete:()=>b(e)},e))})})}):(0,$.jsx)(`div`,{className:`hp-gallery-scroll`,children:S.map((e,t)=>(0,$.jsx)(Kn,{src:e,index:t,onClick:()=>i(S,t)},t))})]})})}function Wn(){let{user:e,signInWithGoogle:t,signOutUser:n}=o(),{events:r,loading:i}=Mn(),{galleries:a}=Nn(),s=d(),[c,l]=(0,v.useState)(null),u=(e,t)=>l({urls:e,index:t}),f=()=>l(null);(0,v.useEffect)(()=>{let e=document.getElementById(`root`);if(!e)return;let t=e.style.maxWidth;return e.style.maxWidth=`100%`,()=>{e.style.maxWidth=t}},[]);let p=new Date().toISOString().split(`T`)[0],m=r.filter(e=>e.date>=p),g=r.filter(e=>e.date<p).reverse(),_=e.state===`admin`,y=e=>document.getElementById(e)?.scrollIntoView({behavior:`smooth`});return(0,$.jsxs)(`div`,{className:`hp-body`,style:{minHeight:`100svh`},children:[(0,$.jsx)(`style`,{children:Vn}),(0,$.jsxs)(`header`,{className:`hp-header`,children:[(0,$.jsxs)(`div`,{className:`hp-logo-wrap`,children:[(0,$.jsx)(`span`,{className:`hp-logo`,children:`Our Home`}),(0,$.jsx)(Bn,{})]}),(0,$.jsx)(`button`,{className:`hp-nav-btn`,onClick:()=>y(`hp-events`),children:`Events`}),(0,$.jsx)(`button`,{className:`hp-nav-btn`,onClick:()=>y(`hp-galleries`),children:`Memories`}),_&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`button`,{className:`hp-icon-btn`,onClick:()=>s(`/events/new`),children:`+`}),(0,$.jsx)(`button`,{className:`hp-logout-btn`,onClick:()=>{window.confirm(`ログアウトしますか？`)&&n()},children:`ログアウト`})]}),e.state===`guest`&&(0,$.jsx)(`button`,{className:`hp-logout-btn`,onClick:()=>t(),children:`ログイン`})]}),(0,$.jsxs)(`div`,{className:`hp-main`,children:[(0,$.jsxs)(`section`,{className:`hp-events-section`,id:`hp-events`,children:[(0,$.jsx)(`h2`,{className:`hp-section-title`,children:`Events`}),i?(0,$.jsx)(`p`,{className:`hp-events-empty`,children:`読み込み中...`}):(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`p`,{className:`hp-sub-title`,children:`これから`}),m.length===0?(0,$.jsx)(`p`,{className:`hp-events-empty`,children:`イベントがありません`}):(0,$.jsx)(`div`,{className:`hp-cards`,children:m.map(e=>(0,$.jsx)(Fn,{event:e},e.id))}),g.length>0&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`p`,{className:`hp-sub-title`,children:`過去`}),(0,$.jsx)(`div`,{className:`hp-cards`,children:g.map(e=>(0,$.jsx)(Fn,{event:e,isPast:!0},e.id))})]})]})]}),(0,$.jsxs)(`aside`,{className:`hp-memories-section`,id:`hp-galleries`,children:[(0,$.jsx)(`h2`,{className:`hp-section-title`,children:`Memories`}),Object.entries(h).map(([e,t])=>(0,$.jsx)(Un,{title:t.title,urls:a[t.field]??[],gallery:e,isAdmin:_,onOpen:u},e))]})]}),c&&(0,$.jsx)(qn,{urls:c.urls,initialIndex:c.index,onClose:f})]})}var Gn=`data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 3 4'%3E%3C/svg%3E`;function Kn({src:e,onClick:t,index:n}){let r=(0,v.useRef)(null),[i,a]=(0,v.useState)(!1);return(0,v.useEffect)(()=>{if(i)return;let e=r.current;if(!e)return;let t=new IntersectionObserver(e=>{e[0].isIntersecting&&(a(!0),t.disconnect())},{rootMargin:`400px`});t.observe(e);let o=600+n*80,s=window.setTimeout(()=>a(!0),o);return()=>{t.disconnect(),window.clearTimeout(s)}},[i,n]),(0,$.jsx)(`img`,{ref:r,src:i?e:Gn,alt:``,className:`hp-gallery-img`,decoding:`async`,onClick:t,style:i?void 0:{background:`rgba(230,138,182,0.12)`}})}function qn({urls:e,initialIndex:t,onClose:n}){let[r,i]=(0,v.useState)(t),a=(0,v.useRef)(null);(0,v.useLayoutEffect)(()=>{let e=a.current;e&&e.scrollTo({left:e.clientWidth*t,behavior:`instant`})},[t]);let o=(0,v.useCallback)(t=>{let n=a.current;n&&i(r=>{let i=Math.max(0,Math.min(e.length-1,r+t));return i===r?r:(n.scrollTo({left:n.clientWidth*i,behavior:`smooth`}),i)})},[e.length]);return(0,v.useEffect)(()=>{let e=e=>{e.key===`Escape`?n():e.key===`ArrowLeft`?o(-1):e.key===`ArrowRight`&&o(1)},t=document.body.style.overflow;return document.body.style.overflow=`hidden`,window.addEventListener(`keydown`,e),()=>{document.body.style.overflow=t,window.removeEventListener(`keydown`,e)}},[o,n]),(0,$.jsxs)(`div`,{className:`hp-lightbox`,onClick:n,role:`dialog`,"aria-modal":`true`,children:[(0,$.jsx)(`button`,{type:`button`,className:`hp-lightbox-close`,onClick:n,"aria-label":`Close`,children:`×`}),(0,$.jsx)(`div`,{className:`hp-lightbox-scroll`,ref:a,onScroll:()=>{let e=a.current;if(!e)return;let t=Math.round(e.scrollLeft/e.clientWidth);i(e=>e===t?e:t)},children:e.map((e,t)=>(0,$.jsx)(`div`,{className:`hp-lightbox-slide`,children:(0,$.jsx)(`img`,{src:e,alt:``,onClick:e=>e.stopPropagation()})},t))}),r>0&&(0,$.jsx)(`button`,{type:`button`,className:`hp-lightbox-nav prev`,"aria-label":`Previous`,onClick:e=>{e.stopPropagation(),o(-1)},children:`‹`}),r<e.length-1&&(0,$.jsx)(`button`,{type:`button`,className:`hp-lightbox-nav next`,"aria-label":`Next`,onClick:e=>{e.stopPropagation(),o(1)},children:`›`}),e.length>1&&(0,$.jsxs)(`div`,{className:`hp-lightbox-counter`,children:[r+1,` / `,e.length]})]})}export{Wn as default};