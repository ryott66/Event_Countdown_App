...
これからの記念日も一緒に増やしていこうね。`;function b(){o({particleCount:300,angle:60,spread:100,origin:{x:0,y:.5},colors:[`#ff69b4`,`#ffd700`,`#87cefa`]}),o({particleCount:300,angle:120,spread:100,origin:{x:1,y:.5},colors:[`#ff69b4`,`#ffd700`,`#87cefa`]}),o({particleCount:600,angle:90,spread:200,startVelocity:50,origin:{x:.5,y:0},colors:[`#ff69b4`,`#ffffff`,`#ffd700`]})}function x({name:e,age:t,imageUrls:n,accent:r=`#e68ab6`,gifts:i=[],aboutTitle:a=v,aboutMessage:o=y,onClose:s}){let[c,l]=(0,u.useState)(`gift`),[d,f]=(0,u.useState)(0),[p,m]=(0,u.useState)(()=>i.map(()=>!1)),g=n.length>0;return(0,u.useEffect)(()=>{let e=document.body.style.overflow;return document.body.style.overflow=`hidden`,()=>{document.body.style.overflow=e}},[]),(0,u.useEffect)(()=>{if(c!==`slideshow`)return;let e=setTimeout(()=>{d<n.length-1?f(d+1):l(`about`)},_);return()=>clearTimeout(e)},[c,d,n.length]),(0,h.jsxs)(`div`,{role:`dialog`,"aria-modal":`true`,style:{position:`fixed`,inset:0,zIndex:1e3,background:`linear-gradient(160deg, #1b1230 0%, #3a1d4d 50%, #6d2b57 100%)`,color:`#fff`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,textAlign:`center`,overflow:`hidden`},children:[(0,h.jsx)(`style`,{children:`
      ...
      `}),c!==`about`&&(0,h.jsx)(`button`,{type:`button`,className:`bc-skip`,onClick:s,style:{position:`absolute`,top:`1rem`,right:`1rem`,zIndex:2,background:`rgba(255,255,255,0.15)`,color:`#fff`,border:`1px solid rgba(255,255,255,0.3)`,borderRadius:`999px`,padding:`0.35rem 0.9rem`,fontSize:`0.8rem`,cursor:`pointer`,backdropFilter:`blur(6px)`},children:`スキップ`}),c===`gift`&&(0,h.jsxs)(`div`,{onClick:()=>{c===`gift`&&(b(),l(`celebrate`))},style:{cursor:`pointer`,padding:`2rem`,display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`1.5rem`},children:[(0,h.jsx)(`div`,{style:{fontSize:`clamp(6rem, 30vw, 12rem)`,lineHeight:1,animation:`bc-drop 1.1s cubic-bezier(.5,1.4,.5,1) both`},children:`🎁`}),(0,h.jsx)(`div`,{style:{animation:`bc-wobble 1.4s ease-in-out infinite`,fontSize:`clamp(1.1rem, 5vw, 1.6rem)`,fontWeight:700,opacity:.95},children:`タップして開けてね 🎀`})]}),c===`celebrate`&&(0,h.jsxs)(`div`,{style:{animation:`bc-pop 0.7s ease both`,padding:`2rem 1.25rem`,display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`0.5rem`,width:`100%`,maxHeight:`100dvh`,overflowY:`auto`},children:[(0,h.jsx)(`div`,{style:{fontSize:`clamp(1.8rem, 8vw, 3rem)`},children:`🎉🎂🎉`}),(0,h.jsx)(`div`,{style:{fontFamily:`"Dancing Script", cursive`,fontSize:`clamp(2.6rem, 12vw, 5rem)`,color:`#ffe3f1`,lineHeight:1.1},children:`Happy Birthday`}),(0,h.jsx)(`div`,{style:{fontFamily:`"Dancing Script", cursive`,fontSize:`clamp(2rem, 9vw, 3.5rem)`,color:`#fff`},children:e}),t!==null&&(0,h.jsxs)(`div`,{style:{fontSize:`clamp(1rem, 5vw, 1.4rem)`,opacity:.85,marginTop:`0.5rem`},children:[`🎈 `,t,` 歳おめでとう 🎈`]}),i.length>0&&(0,h.jsx)(`div`,{style:{marginTop:`1.5rem`,width:`min(98vw, 760px)`},children:(0,h.jsx)(`div`,{style:{display:`flex`,flexWrap:`nowrap`,justifyContent:`center`,gap:`0.6rem`},children:i.map((e,t)=>{let n=p[t];return(0,h.jsx)(`button`,{type:`button`,className:`bc-btn`,onClick:()=>m(e=>e.map((e,n)=>n===t?!0:e)),"aria-expanded":n,style:{flex:`1 1 0`,minWidth:0,aspectRatio:`1 / 1`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:n?`linear-gradient(135deg, ${r}40, rgba(255,255,255,0.06))`:`rgba(255,255,255,0.08)`,border:`1px solid ${r}66`,borderRadius:`18px`,padding:`0.4rem`,color:`#fff`,cursor:n?`default`:`pointer`,textAlign:`center`,overflow:`hidden`},children:n?(0,h.jsxs)(`div`,{style:{animation:`bc-pop 0.4s ease both`,display:`flex`,flexDirection:`column`,gap:`0.3rem`,alignItems:`center`,maxWidth:`100%`},children:[(0,h.jsx)(`div`,{style:{fontSize:`clamp(1.3rem, 6vw, 2.6rem)`,lineHeight:1.15},children:e.emoji??`🎁`}),(0,h.jsx)(`div`,{style:{fontWeight:700,fontSize:`clamp(0.78rem, 3.4vw, 1.15rem)`},children:e.title}),e.detail&&(0,h.jsx)(`div`,{style:{fontSize:`0.8rem`,opacity:.9,lineHeight:1.4,whiteSpace:`pre-line`},children:e.detail})]}):(0,h.jsx)(`div`,{style:{fontSize:`clamp(2.2rem, 11vw, 3.6rem)`,lineHeight:1,animation:`bc-wobble 1.6s ease-in-out infinite`},children:`🎁`})},t)})})}),(0,h.jsx)(`button`,{type:`button`,className:`bc-btn`,onClick:()=>l(g?`slideshow`:`about`),style:{marginTop:`1.5rem`,background:r,color:`#fff`,border:`none`,borderRadius:`999px`,padding:`0.6rem 1.6rem`,fontSize:`0.95rem`,fontWeight:700,cursor:`pointer`,boxShadow:`0 8px 20px rgba(0,0,0,0.3)`},children:`つづける →`})]}),c===`slideshow`&&g&&(0,h.jsxs)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#000`},children:[(0,h.jsx)(`img`,{src:n[d],alt:``,decoding:`async`,style:{width:`100%`,height:`100%`,objectFit:`contain`,animation:`bc-kenburns ${_+400}ms ease-out both`}},d),(0,h.jsx)(`div`,{style:{position:`absolute`,bottom:`1.2rem`,left:0,right:0,display:`flex`,justifyContent:`center`,gap:`0.4rem`},children:n.map((e,t)=>(0,h.jsx)(`span`,{style:{width:t===d?`1.6rem`:`0.5rem`,height:`0.5rem`,borderRadius:`999px`,background:t===d?r:`rgba(255,255,255,0.5)`,transition:`width 0.3s ease`}},t))}),(0,h.jsx)(`button`,{type:`button`,onClick:()=>{d<n.length-1?f(d+1):l(`about`)},style:{position:`absolute`,bottom:`2.5rem`,right:`1.2rem`,background:`rgba(255,255,255,0.18)`,color:`#fff`,border:`1px solid rgba(255,255,255,0.35)`,borderRadius:`999px`,padding:`0.35rem 1rem`,fontSize:`0.85rem`,cursor:`pointer`,backdropFilter:`blur(6px)`},children:`次へ →`})]}),c===`about`&&(0,h.jsxs)(`div`,{style:{animation:`bc-fade 0.5s ease both`,padding:`2rem 1.25rem`,width:`min(92vw, 540px)`,display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`1.1rem`},children:[(0,h.jsx)(`div`,{style:{fontSize:`2.5rem`},children:`🎂`}),(0,h.jsx)(`h2`,{style:{fontFamily:`"Dancing Script", cursive`,fontSize:`clamp(2rem, 8vw, 2.8rem)`,color:`#ffe3f1`,margin:0,whiteSpace:`nowrap`},children:a}),(0,h.jsx)(`p`,{style:{fontSize:`1rem`,lineHeight:1.95,opacity:.94,margin:0,whiteSpace:`pre-line`,textAlign:`center`,textWrap:`pretty`},children:o}),(0,h.jsx)(`button`,{type:`button`,className:`bc-btn`,onClick:s,style:{marginTop:`0.8rem`,background:r,color:`#fff`,border:`none`,borderRadius:`999px`,padding:`0.7rem 2rem`,fontSize:`1rem`,fontWeight:700,cursor:`pointer`,boxShadow:`0 8px 20px rgba(0,0,0,0.3)`},children:`サイトを見る →`})]})]})}var S=`/Event_Countdown_App/`;function C(){o({particleCount:300,angle:60,spread:100,origin:{x:0,y:.5},colors:[`#ff69b4`,`#ffd700`,`#87cefa`]}),o({particleCount:300,angle:120,spread:100,origin:{x:1,y:.5},colors:[`#ff69b4`,`#ffd700`,`#87cefa`]}),o({particleCount:600,angle:90,spread:200,startVelocity:50,origin:{x:.5,y:0},colors:[`#ff69b4`,`#ffffff`,`#ffd700`]})}function w(e){let[t,n]=(0,u.useState)({days:0,hours:0,minutes:0,seconds:0,isToday:!1}),[r,i]=(0,u.useState)(!1);return(0,u.useEffect)(()=>{let t=setInterval(()=>{let t=new Date,a=new Date(e);if(t.getFullYear()===a.getFullYear()&&t.getMonth()===a.getMonth()&&t.getDate()===a.getDate()){n({days:0,hours:0,minutes:0,seconds:0,isToday:!0}),r||(C(),i(!0));return}let o=a.getTime()-t.getTime();if(o>0){let e=Math.floor(o/1e3);n({days:Math.floor(e/86400),hours:Math.floor(e%86400/3600),minutes:Math.floor(e%3600/60),seconds:e%60,isToday:!1})}},1e3);return()=>clearInterval(t)},[r,e]),t}function T({event:e}){let t=a(),{user:r}=n(),{days:i,hours:o,minutes:l,seconds:d,isToday:f}=w(e.date),[_,v]=(0,u.useState)(!1),[y,b]=(0,u.useState)(!1),C=(0,u.useRef)(null),T=(0,u.useRef)(null),[E,D]=(0,u.useState)(()=>window.innerWidth),[O,k]=(0,u.useState)(!1),A=f||O,[j,M]=(0,u.useState)(!1),[N,P]=(0,u.useState)(!1),F=`birthday-climax-seen:${e.id}:${e.date}`;if(!N&&f){P(!0);let e=!1;try{e=localStorage.getItem(F)===`1`}catch{}e||M(!0)}let I=()=>{M(!1);try{localStorage.setItem(F,`1`)}catch{}},L=e.customData??{},R=new Date(e.date).getFullYear(),z=L.name??e.title,B=L.coupleName??e.title,V=typeof L.birthYear==`number`?R-L.birthYear:null,H=L.bookImages??[],U=L.trip,W=!!(U&&(U.title||U.dates||U.message)),G=U?.heading??`思い出`,K=L.footerMessage??``;(0,u.useEffect)(()=>{let e=document.getElementById(`root`);if(!e)return;let t=e.style.maxWidth;return e.style.maxWidth=`100%`,()=>{e.style.maxWidth=t}},[]),(0,u.useEffect)(()=>{let e=()=>D(window.innerWidth);return window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]);let q=E<768,J=q?Math.min(E-80,250):400,Y=Math.round(J*1.4);return(0,h.jsxs)(`div`,{className:`b26-body`,children:[(0,h.jsx)(`style`,{children:`
    ...
    .b26-main {
      ...
      background-image: url("${S}images/background_main.webp");
    ...
    #b26-trip {
      ...
      background-image: url("${S}images/Trip.webp");
  ...
  `}),(0,h.jsxs)(`header`,{className:`b26-header`,children:[(0,h.jsx)(`button`,{className:`b26-back-btn`,onClick:()=>t(`/`),children:`←`}),r.state===`admin`&&(0,h.jsx)(`button`,{className:`b26-edit-btn`,onClick:()=>t(`/events/${e.id}/edit`),children:`Edit`}),(0,h.jsx)(`div`,{className:`b26-header-left`,children:(0,h.jsx)(`i`,{ref:C,id:`b26-cake`,className:`fa-solid fa-cake-candles`,onClick:()=>m(C.current,v,_,`bigcake`)})}),(0,h.jsxs)(`nav`,{children:[(0,h.jsx)(`a`,{href:`#b26-countdown`,className:`b26-header-btn`,onClick:e=>{e.preventDefault(),document.getElementById(`b26-countdown`)?.scrollIntoView({behavior:`smooth`})},children:`Countdown`}),W&&(0,h.jsx)(`a`,{href:`#b26-trip`,className:`b26-header-btn`,onClick:e=>{e.preventDefault(),document.getElementById(`b26-trip`)?.scrollIntoView({behavior:`smooth`})},children:`Date`})]}),(0,h.jsx)(`div`,{className:`b26-header-right`,children:(0,h.jsxs)(`a`,{href:`#b26-first`,onClick:e=>{e.preventDefault(),document.getElementById(`b26-first`)?.scrollIntoView({behavior:`smooth`})},children:[z,`'s Birthday`]})})]}),(0,h.jsxs)(`div`,{className:`b26-main`,children:[(0,h.jsx)(`h1`,{id:`b26-first`,children:B}),(0,h.jsx)(`div`,{id:`b26-countdown`,children:A?(0,h.jsxs)(h.Fragment,{children:[`🎉 `,(0,h.jsx)(`span`,{className:`b26-birthday-script`,children:`Happy Birthday`}),` 🎉`,(0,h.jsx)(`br`,{}),(0,h.jsxs)(`span`,{className:`b26-birthday-script`,children:[`　`,z]}),V!==null&&(0,h.jsx)(`span`,{className:`b26-birthday-num`,children:V})]}):(0,h.jsxs)(h.Fragment,{children:[`Countdown to Birthday:`,(0,h.jsx)(`br`,{}),(0,h.jsxs)(`span`,{className:`b26-cdtime`,children:[i,` days `,String(o).padStart(2,`0`),`:`,String(l).padStart(2,`0`),`:`,String(d).padStart(2,`0`)]})]})})]}),H.length>0&&(0,h.jsx)(g,{title:`Book`,accent:`rgba(230,138,182,0.9)`,defaultOpen:!0,children:(0,h.jsx)(`div`,{className:`b26-book-section`,style:{height:`auto`,paddingBottom:`3rem`},children:(0,h.jsx)(p,{width:J,height:Y,size:`fixed`,minWidth:150,maxWidth:1e3,minHeight:200,maxHeight:1536,maxShadowOpacity:q?.3:.5,showCover:!1,mobileScrollSupport:!0,startPage:0,drawShadow:!0,flippingTime:q?600:1e3,usePortrait:q,startZIndex:0,autoSize:!1,clickEventForward:!0,useMouseEvents:!0,showPageCorners:!0,disableFlipByClick:!1,style:{},className:`book`,children:H.map((e,t)=>(0,h.jsx)(`div`,{className:`page`,children:(0,h.jsx)(`img`,{src:e,width:J,height:Y,alt:``,loading:t===0?`eager`:`lazy`,decoding:`async`})},t))})})}),W&&(0,h.jsx)(g,{title:G,accent:`rgb(224,143,81)`,defaultOpen:!1,children:(0,h.jsxs)(`div`,{id:`b26-trip`,children:[(0,h.jsxs)(`h2`,{className:`b26-trip-title`,children:[U?.title,U?.dates&&(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(`br`,{}),U.dates]})]}),U?.message&&(0,h.jsx)(`div`,{className:`b26-trip-message`,children:(0,h.jsx)(`p`,{children:U.message})})]})}),(0,h.jsx)(`div`,{style:{padding:`3rem 0`},children:(0,h.jsx)(c,{event:e,accent:`#e68ab6`,title:`Memories`})}),(0,h.jsx)(s,{event:e,accent:`#e68ab6`}),(0,h.jsxs)(`footer`,{className:`b26-footer`,children:[(0,h.jsx)(`div`,{className:`b26-footer-left`,children:(0,h.jsx)(`i`,{ref:T,id:`b26-heart`,className:`fa-solid fa-heart`,onClick:()=>m(T.current,b,y,`bigheart`)})}),K&&(0,h.jsx)(`div`,{className:`b26-footer-right`,children:K}),(0,h.jsx)(`p`,{className:`b26-footer-end`,children:`Created by Ryo`})]}),A&&!j&&(0,h.jsx)(`button`,{type:`button`,onClick:()=>M(!0),style:{position:`fixed`,left:`1rem`,bottom:`1rem`,zIndex:50,padding:`0.55rem 1.1rem`,borderRadius:`999px`,border:`none`,background:`#e68ab6`,color:`#fff`,fontSize:`0.85rem`,fontWeight:700,boxShadow:`0 4px 14px rgba(0,0,0,0.22)`,cursor:`pointer`},children:`🎬 もう一度見る`}),j&&(0,h.jsx)(x,{name:z,age:V,imageUrls:e.imageUrls??[],accent:`#e68ab6`,gifts:L.gifts,aboutTitle:L.aboutTitle,aboutMessage:L.aboutMessage,onClose:I}),!1]})}export{T as default};