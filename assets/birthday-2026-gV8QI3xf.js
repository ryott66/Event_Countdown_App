...
.stf__hardInnerShadow {
  ...
  top: 0;
    ...
    .b26-main {
      ...
      background-image: url("${m}images/background_main.webp");
    ...
    #b26-trip {
      ...
      background-image: url("${m}images/Trip.webp");
  ...
  `}),(0,p.jsxs)(`header`,{className:`b26-header`,children:[(0,p.jsx)(`button`,{className:`b26-back-btn`,onClick:()=>t(`/`),children:`←`}),r.state===`admin`&&(0,p.jsx)(`button`,{className:`b26-edit-btn`,onClick:()=>t(`/events/${e.id}/edit`),children:`Edit`}),(0,p.jsx)(`div`,{className:`b26-header-left`,children:(0,p.jsx)(`i`,{ref:x,id:`b26-cake`,className:`fa-solid fa-cake-candles`,onClick:()=>f(x.current,v,g,`bigcake`)})}),(0,p.jsxs)(`nav`,{children:[(0,p.jsx)(`a`,{href:`#b26-countdown`,className:`b26-header-btn`,onClick:e=>{e.preventDefault(),document.getElementById(`b26-countdown`)?.scrollIntoView({behavior:`smooth`})},children:`Countdown`}),(0,p.jsx)(`a`,{href:`#b26-trip`,className:`b26-header-btn`,onClick:e=>{e.preventDefault(),document.getElementById(`b26-trip`)?.scrollIntoView({behavior:`smooth`})},children:`Date`})]}),(0,p.jsx)(`div`,{className:`b26-header-right`,children:(0,p.jsx)(`a`,{href:`#b26-first`,onClick:e=>{e.preventDefault(),document.getElementById(`b26-first`)?.scrollIntoView({behavior:`smooth`})},children:`Remina's Birthday`})})]}),(0,p.jsxs)(`div`,{className:`b26-main`,children:[(0,p.jsx)(`h1`,{id:`b26-first`,children:`Ryo & Remina`}),(0,p.jsx)(`div`,{id:`b26-countdown`,children:u?(0,p.jsxs)(p.Fragment,{children:[`🎉 `,(0,p.jsx)(`span`,{className:`b26-birthday-script`,children:`Happy Birthday`}),` 🎉`,(0,p.jsx)(`br`,{}),(0,p.jsxs)(`span`,{className:`b26-birthday-script`,children:[`　`,`Remina`]}),(0,p.jsx)(`span`,{className:`b26-birthday-num`,children:`23`})]}):(0,p.jsxs)(p.Fragment,{children:[`Countdown to Birthday:`,(0,p.jsx)(`br`,{}),(0,p.jsxs)(`span`,{className:`b26-cdtime`,children:[i,` days `,String(o).padStart(2,`0`),`:`,String(s).padStart(2,`0`),`:`,String(l).padStart(2,`0`)]})]})})]}),(0,p.jsxs)(`div`,{className:`b26-book-section`,children:[(0,p.jsx)(`h2`,{className:`b26-booksection-title`,children:`Book`}),(0,p.jsx)(d,{width:O,height:k,size:`fixed`,minWidth:150,maxWidth:1e3,minHeight:200,maxHeight:1536,maxShadowOpacity:D?.3:.5,showCover:!1,mobileScrollSupport:!0,startPage:0,drawShadow:!0,flippingTime:D?600:1e3,usePortrait:D,startZIndex:0,autoSize:!1,clickEventForward:!0,useMouseEvents:!0,showPageCorners:!0,disableFlipByClick:!1,style:{},className:`book`,children:h.map((e,t)=>(0,p.jsx)(`div`,{className:`page`,children:(0,p.jsx)(`img`,{src:e,width:O,height:k,alt:``,loading:t===0?`eager`:`lazy`,decoding:`async`})},t))})]}),(0,p.jsxs)(`div`,{id:`b26-trip`,children:[(0,p.jsxs)(`h2`,{className:`b26-trip-title`,children:[`Karuizawa`,(0,p.jsx)(`br`,{}),`6/26~6/27`]}),(0,p.jsx)(`div`,{className:`b26-trip-message`,children:(0,p.jsx)(`p`,{children:`Thank you`})})]}),e.imageUrls?.length>0&&(0,p.jsxs)(`div`,{className:`b26-new-memories`,children:[(0,p.jsx)(`h2`,{className:`b26-memory-title`,children:`2026 Memories`}),(0,p.jsx)(`div`,{className:`b26-new-gallery`,children:e.imageUrls.map((e,t)=>(0,p.jsx)(`img`,{src:e,alt:``,loading:`lazy`,decoding:`async`,onClick:()=>A(e)},t))})]}),T&&(0,p.jsx)(`div`,{className:`b26-lightbox`,onClick:j,role:`dialog`,"aria-modal":`true`,children:(0,p.jsxs)(`div`,{className:`b26-lightbox-inner`,onClick:e=>e.stopPropagation(),children:[(0,p.jsx)(`button`,{type:`button`,className:`b26-lightbox-close`,onClick:j,"aria-label":`Close`,children:`×`}),(0,p.jsx)(`img`,{src:T,alt:`Expanded memory`})]})}),(0,p.jsxs)(`footer`,{className:`b26-footer`,children:[(0,p.jsx)(`div`,{className:`b26-footer-left`,children:(0,p.jsx)(`i`,{ref:S,id:`b26-heart`,className:`fa-solid fa-heart`,onClick:()=>f(S.current,b,y,`bigheart`)})}),(0,p.jsx)(`div`,{className:`b26-footer-right`,children:`大好きなれみちゃん、いつもありがとう😄`}),(0,p.jsx)(`p`,{className:`b26-footer-end`,children:`Created by Ryo`})]})]})}export{v as default};